...
if os.name == 'nt' and hasattr(settings, 'TESSERACT_PATH'):  # Windows
...
class OCRProcessor:
    ...
    def __init__(self):
        ...
        # Use settings for all configurations
        self.SUPPORTED_IMAGE_FORMATS = settings.SUPPORTED_IMAGE_FORMATS
        self.SUPPORTED_DOC_FORMATS = settings.SUPPORTED_DOC_FORMATS
        self.MAX_IMAGE_SIZE = (settings.OCR_MAX_IMAGE_SIZE, settings.OCR_MAX_IMAGE_SIZE)
        self.OCR_TIMEOUT = settings.OCR_TIMEOUT
        self.MIN_CONFIDENCE_THRESHOLD = settings.OCR_MIN_CONFIDENCE
